...
if __name__ == '__main__':
  ...
  net3 = fls.getNetwork(
    ...
    components=[
      ...
      {'nodes': ['E','F'], 'sense': -1, 'comp': fls.getComp(comp='PumpCentrifugal', dataQH=pr0['dataQH'], impeller0=pr0['impeller0'], speed0=pr0['speed0']-500)},
